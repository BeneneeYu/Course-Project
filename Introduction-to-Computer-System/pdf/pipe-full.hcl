...
# I implemented the iaddq instruction so as to make the instruction of adding 
# an immediate to a register finish within one instruction.
# Below is the proccesses of the iaddq instruciton in six stages
