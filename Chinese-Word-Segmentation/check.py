...
from wordseg.BiLSTM_CRF_model import BiLSTM_CRF
...
for f_name, func in funcs.items():
    print(f"\n检查{f_name}模型 -->")
    examples = open("example_dataset/old/input.utf8", encoding="utf8").readlines()
    examples = [ele.strip() for ele in examples]
    gold = open("example_dataset/old/gold.utf8", encoding="utf8").readlines()
