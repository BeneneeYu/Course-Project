...
bt_config_t config;
get_task_handler_t get_task_handler;
list_t *chunk_tracker;
list_t *chunk_ihave;
upload_pool_t up_pool;
download_pool_t down_pool;
...
int main(int argc, char **argv) {
...
#ifdef TESTING
    config.identity = 18302010009; // your student number here
    ...
    initiate_upload_pool(&up_pool, config.max_conn);
    peer_run(&config);
    return 0;
}
